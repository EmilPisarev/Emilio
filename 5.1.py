...
если число с  плавающей запятой ( bmi ) <  16,5 :
    print ( "Индекс тела равен:" , "% .2f"  %  bmi , "кг / м²," , "у Вас выраженный дефицит массы тела" )
elif  float ( bmi ) > =  16,5  и  float ( bmi ) <=  18,49 :
    print ( "Индекс тела равен:" , "% .2f"  %  bmi , "кг / м²," , "у Вас Недостаточный масса тела" )
elif  float ( bmi ) > =  18,5  и  float ( bmi ) <=  24,99 :
    print ( "Индекс тела равен:" , "% .2f"  %  bmi , "кг / м²," , "у Вас норма" )
elif  float ( bmi ) > =  25  и  float ( bmi ) <=  29,99 :
    print ( "Индекс тела равен:" , "% .2f"  %  bmi , "кг / м²," , "у Вас избыточная масса тела" )
elif  float ( bmi ) > =  30  и  float ( bmi ) <=  34,99 :
    print ( "Индекс тела равенство:" , "% .2f"  %  bmi , "кг / м²," , "у Вас ожирение первой степени" )
elif  float ( bmi ) > =  35  и  float ( bmi ) <=  39,99 :
